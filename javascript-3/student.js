...
//Inside of addItem, invoke displayData() which is a function we created that takes care
...
//Using an else/if statement, check if the number is greater than or equal to 5, return the string
//'That looks like a big trip' from the function.
