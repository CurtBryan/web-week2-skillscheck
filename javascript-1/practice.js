...
// and love which will be a string of something you love. Have the function take the two
//parameters and retrun a string that says "NAMEPARAM loves LOVEPARAM" with the
...
// age will be your age as a number. greeter will be a method that returns the string
...
// Create a function called 'bigOrSmall' that takes in one parameter, arr. Create a new array inside of
//bigOrSmall called 'answers'. Loop over the passed in arr param.
...
//create an empty array called 'reversed'. Using a for loop, loop over the passed in array in reverse and
//add each item to the new reversed array. Finally, return the new reversed array
...
// Below is an array, myNumbers. We will be using .map, .filter, .reduce and .forEach to
//manipulate the array in some form
...
// Code HereS
const doubled = myNumbers.map(function(n) {
  return n * 2;
});
//////////////////PROBLEM 15////////////////////
...
// Code Here
const filtered = myNumbers.filter(function(n) {
  if (n > 100) {
    return n;
  } else {
    return;
...
// Code Here
const total = myNumbers.reduce(function(total, sum) {
  return total + sum;
});
//////////////////PROBLEM 17////////////////////
...
//   myNumbersIndex.write(.indexOf(elements))
// }
//////////////////PROBLEM 18////////////////////
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map(function(n) {
  if (notGeorge !== "George") {
    return "George";
  }
});
...
// Using the people array, let's filter out everyone that isn't our friend to a new array called 'enemies'.
//Use .filter()
const people = [
...
// Code Here
const enemies = people.filter(function(n) {
  if (n.friend === false) {
    return n;
  } else {
    return;
...
// Code Here
const totallyAwesome = people.reduce(function(total, n) {
  return total + n.awesomeLevel;
});
